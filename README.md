...
- [ ] Modelagem de banco de dados para médicos. Os campso são: Nome, Especialidade, Celular, Descrição, Foto
- [ ] Utilizando o padrão MVC, exibir as páginas do projeto (index.html, appontment_success.html, doctor.html)
- [ ] Formulário Fazer com que o formulário  persista os dados no banco de dados modelado. Os 3 campos são obrigatórios
...
- [ ] Exibir a lista de doutores cadastrados no banco de dados na index, temos uma área chamada "Meet the Wealth.life Specialists Doctors" *** OBS: Não é necessário criar um painel de controle para cadastros dos médicos, o objetivo é visualizar a integração com a view e não o cadastros ***
